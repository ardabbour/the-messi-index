...
Edition 003 contains 47 statistical plates, a filterable record ledger and an interactive scoring-pace translator.
...
- `data/live-world-cup-2026.json` is the dated source of truth for the tournament snapshot; its status controls live/final interface wording, and its review deadline prevents stale provisional data from passing after the final.
