...
Edition 003 contains 37 statistical plates, a filterable record ledger and an interactive scoring-pace translator.
...
- `data/live-world-cup-2026.json` is the dated source of truth for the in-progress tournament snapshot.
